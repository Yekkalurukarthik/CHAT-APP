    ...
    <div className='p-4 sm:p-6 lg:p-8'>
      <div className='container mx-auto space-y-10'>
        ...
        {loadingFriends ? (
          ...
          <div className='grid grid-clos-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4'>
                    ...
                    <div className='card-body p-5 space-y-4'>
                      <div className='flex items-center gap-3'>
                        <div className='avatar size-16 rounded-full'>
                          <img className="avatar size-16 rounded-full" src={user.profilePic} alt={user.fullName} />
                        </div>
                        <div>
                      ...
                      {user.bio && <p className='text-sm opacity-70 mt-4'>{user.bio}</p>}
